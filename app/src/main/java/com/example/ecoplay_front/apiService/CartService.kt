...
interface CartService {
    @POST("carts/get")
    fun getProductsInCart(@Header("token") token: String?, @Body cartIdRequest: CartIdRequest): Call<List<ProductModel>>
    @PUT("carts/adPtC")
    fun addToCart(@Header("token") token: String?,@Body addToCartRequest: AddToCartRequest): Call<AddToCartResponse>
    ...
    @POST("carts/total")
    fun calculateCartTotal(@Header("token") token: String?,@Body request: CalculateCartTotalRequest): Call<CalculateCartTotalResponse>
    @POST("carts/pay")
    ...
    fun deleteProductFromCart(@Header("token") token: String?,@Body body: RemoveProductRequest): Call<ResponseMessage>
}
